<template>
  <div class="h-screen flex bg-gray-200">
              ...
              <li class="">
                ...
                >
                  ...
                  >
                    ...
                    <!-- parent link -->                
                    <div                      
                      @click.prevent="toggleActive(2, false)" 
                ...
                <!-- children -->
                <div class="pt-2 pl-4" :class="{'hidden': !sidebar ||navItem !== 2}">
                  <ul class="flex flex-col pl-2 text-gray-500 border-l border-gray-200">
                    <li
                      @click.prevent="toggleActive(21)" 
                      :class="{'text-gray-800': childNavItem === 21}"
                    >
                      <nuxt-link
                        to="/admin/products"                    
                    ...
                    <li
                      @click.prevent="toggleActive(22)" 
                      :class="{'text-gray-800': childNavItem === 22}"
                    >
                      <nuxt-link
                    ...
                    <li
                      @click.prevent="toggleActive(23)" 
                      :class="{'text-gray-800': childNavItem === 23}"
                    >
                      <nuxt-link
                        to="#"                    
                        class="inline-block w-full px-4 py-2 text-xs rounded hover:bg-gray-800 hover:text-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-500 focus:text-green-300"
    ...
    <div class="w-full flex flex-col overflow-auto"> 
      ...
      <header class="w-full bg-white shadow-sm px-4 flex items-center justify-between">
      <!-- right arrow -->

    ...
    <Slider />
      ...
      <div class="container">
        ...
        <div v-if="banners.length > 0" class="flex flex-col md:flex-row gap-6 mb-14">
          <div v-for="banner in banners" :key="banner.id" class="w-full md:w-1/2">
            <BackgroundImage :image-url="url(banner.image)">
              <div class="w-full md:w-2/3 p-3 lg:p-6 absolute top-0 left-0 ">
                ...
                <h3 class="font-bold text-xl xl:text-4xl mb-4 lg:mb-8 leading-tight">{{ banner.description }}</h3>                                
              </div>

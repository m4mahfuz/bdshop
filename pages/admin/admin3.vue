<template>
  <div class="h-screen flex items-stretch bg-gray-200">
    <aside 
      ...
      :class="{'w-20': !sidebar, 'w-64': sidebar, 'overflow-x-hidden': !sidebar}"
    >
      <div class="px-6 pt-6">
        <div class="flex items-center justify-between">
          ...
          <!-- <button
            ...
            class="absolute left-0 flex items-center justify-center p-0.5 rounded bg-red-500 z-50 focus:outline-none focus:ring-1 focus:ring-gray-500"
            :class="{hidden: sidebar}"
          >
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-300" viewBox="0 0 20 20" fill="currentColor">
      ...
      <header class="h-20 bg-white shadow-sm px-4 flex items-center">
        ...
        <nav class="ml-auto items-center hidden lg:flex">
          ...
          <div class="relative ml-4" v-click-outside="hideDropdown">
            ...
            <!-- Dropdown -->
            <!-- <div v-if="showDropdown" class="dropdown absolute z-50 mt-3 rounded-md shadow-lg w-48 right-0 py-2 bg-gradient-to-r from-white to-gray-200">
              <div class="px-4 py-2 text-xs text-gray-400">
                Manage Acount
              </div>
              <nuxt-link to="/dashboard/profile" class="block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 transition">Profile</nuxt-link>
              <div class="border-t border-gray-100"></div>
              <nuxt-link to="/logout" class="block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 transition">Logout</nuxt-link>            
            </div> -->

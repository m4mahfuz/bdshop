    ...
    <!-- <h1 class="text-2xl">
      Add Deal
        ...
        <div class="my-8 flex justify-between">
                ...
                <button @click.prevent="update(offer)" type="button" :disabled="!isValid" class="px-12 py-2 leading-5 text-white transition-colors duration-200 transform bg-blue-500 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600 disabled:bg-blue-300">Update</button>
                </div>
        </div>
    ...
    methods: {
      ...
      fillupFormByFound(offer) {
        this.offer = {
          ...
          starting: this.convertDateFormat(offer.starting),
          ending: this.convertDateFormat(offer.ending),
        }
      },  
      ...
      update(offer) {
        ...
        this.$axios.$put(`/admin/offers/${offer.id}`, offer)
        .then(response => {
            this.loader = false;
            this.updateLocalStorage(offer);

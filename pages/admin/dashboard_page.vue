<template>
  <div class="h-screen flex items-stretch bg-gray-200">
        ...
        <div class="flex flex-col">      
          <div class="px-6 pt-4">
            <ul class="flex flex-col space-y-2">
              ...
              <li class="">
                <div
                  class="relative flex justify-between rounded text-gray-500 hover:bg-gray-800 hover:text-white"
                >
                  <div 
                  ...
                  >
                    ...
                    <!-- parent link -->                
                    <div                      
                      @click.prevent="toggleActive(1, false)" 
                      class="inline-block w-full cursor-pointer py-2 pl-8 pr-4 text-xs rounded hover:bg-gray-800 focus:outline-none focus:ring-1 focus:ring-gray-500 focus:bg-gray-800 focus:text-green-300"
                      :class="{'invisible': !sidebar }"
                      >Content
                    </div>
                  </div>
                  <button 
                    class="absolute right-0 flex items-center p-1" :class="{'invisible': !sidebar }" tabindex="-1"
                  >                
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 -rotate-180 transition-transform ease-in-out delay-200" viewBox="0 0 20 20" fill="currentColor"
                    :class="{'rotate-90': navItem === 1 }"
                    >
                      <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
                    </svg>
                  </button>
                ...
                <!-- children -->
                <div class="pt-2 pl-4" :class="{'hidden': !sidebar ||navItem !== 1}">
                  <ul class="flex flex-col pl-2 text-gray-500 border-l border-gray-200">
                    <li
                      @click.prevent="toggleActive(1)" 
                      :class="{'text-gray-800': childNavItem === 1}"
                    >
                      <nuxt-link
                        to="#"                    
                        class="inline-block w-full px-4 py-2 text-xs rounded hover:bg-gray-800 hover:text-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-500 focus:text-green-300"
                        >Products
                      </nuxt-link>
                    </li>
                    <li
                      @click.prevent="toggleActive(2)" 
                      :class="{'text-gray-800': childNavItem === 2}"
                    >
                      <nuxt-link
                        to="#"                    
                        class="inline-block w-full px-4 py-2 text-xs rounded hover:bg-gray-800 hover:text-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-500 focus:text-green-300"
                    ...
                    <li
                      @click.prevent="toggleActive(3)" 
                      :class="{'text-gray-800': childNavItem === 3}"
                    >
                      <nuxt-link
                        to="#"                    
                        class="inline-block w-full px-4 py-2 text-xs rounded hover:bg-gray-800 hover:text-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-500 focus:text-green-300"
      ...
      <footer>
        ...
        <div class="pl-6 px-4 pt-4 pb-6 bg-slate-100 flex items-center justify-between">
          <div class="flex items-center">
            ...
            <div v-if="false" class="flex flex-col pl-3" :class="{'invisible': !sidebar }">
              <div class="text-sm text-gray-500">{{this.$auth.user.name}}</div>
    ...
    <div class="grow flex flex-col"> 
      ...
      <header class="h-20 bg-white shadow-sm px-4 flex items-center">
      <!-- right arrow -->
      <!--   <div class="relative w-20 h-20">
        ...
        <!-- search -->
        <div class="relative">
          <svg xmlns="http://www.w3.org/2000/svg" class="absolute left-3 top-3 text-gray-400 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <nav class="ml-auto items-center hidden lg:flex">
          <!-- Notifications -->
          <div>

            ...
            <tbody>
                ...
                >                    
                    ...
                    <td class="py-2 px-6">
                        ...
                        <span v-if="product.pivot.additional_quantity" class="text-xs text-gray-500">+ {{product.pivot.additional_quantity}}
                        </span>
                    </td>
                    <td class="py-2 px-6">
                        <p v-if="product.pivot.discounted_price !==null">
...
<script>
    ...
    export default {
        ...
        async mounted() {
            ...
            this.setQrCode();
            await this.getOrderProductsByUUID(this.$route.params.order);                        
            this.loader = false
        },
        
        computed: {    
            ...mapState('orders', ['order', 'products']),           
        },
        methods: {
            ...mapActions('orders', ['getOrderProductsByUUID', 'getOrderByUUID']),
            setBarCode(code) {
